      ...
      EM.run {
        ...
        http.callback {
          ...
          links.each do |link|
            ...
            print link.attr('href').match(/\/\/([^\.]*)\.craigslist.org/)[1]
            print " "
